...
function ConsolePrincipal({ onIncrease, reset }) {
  ...
  return (
    <S.ContainerControl>
      <div className="controls">
        <div className="control-painel">
          ...
          <div className="container-control">
            <button
              onClick={() => handleChange("INCREASE", "KVP")}
              aria-label="Increase kV"
            >
              +
            </button>
            <span className="control-name">{state.kvp} kV</span>
            <button
              onClick={() => handleChange("DECREASE", "KVP")}
              aria-label="Decrease kV"
            >
              -
            </button>
          </div>
        ...
        <div className="control-painel">
          ...
          <div className="container-control">
            <button
              onClick={() => handleChange("INCREASE", "MAS")}
              aria-label="Increase MAS"
            >
              +
            </button>
            <span className="control-name">{state.mas} MAS</span>
            <button
              onClick={() => handleChange("DECREASE", "MAS")}
              aria-label="Decrease MAS"
            >
              -
            </button>
          </div>
        ...
        <div className="control-painel">
          ...
          <div className="container-control">
            <button
              onClick={() => handleChange("INCREASE", "MA")}
              aria-label="Increase MA"
            >
              +
            </button>
            <span className="control-name">{state.ma} MA</span>
            <button
              onClick={() => handleChange("DECREASE", "MA")}
              aria-label="Decrease MA"
            >
              -
            </button>
          </div>
      ...
      <S.ButtonDisplay onClick={startCountdown}>
        {readyRx ? "Disparar" : `Preparar (${time})`}
      </S.ButtonDisplay>
    </S.ContainerControl>
  );
}
